...
class HiFormer(nn.Module):
    def __init__(self, config, img_size=224, in_chans=3, n_classes=9):
        ...
        self.ConvUp_1 = ConvUpsample(in_chans=64, upsample=False)
        self.ConvUp_2 = ConvUpsample(in_chans=128, upsample=False)
        self.ConvUp_3 = ConvUpsample(in_chans=256, upsample=False)
        self.ConvUp_4 = ConvUpsample(in_chans=512, out_chans=[128,128,128,128], upsample=True)
