...
from .Res2Net_InfNet import res2net50_v1b_26w_4s, res2net101_v1b_26w_4s
...
class Inf_Net(nn.Module):
    def __init__(self, channel=32, n_class=1):
        ...
        self.ParDec = aggregation(channel)
        ...
        self.final_1 = nn.Conv2d(1, n_class, 1)
        self.final_2 = nn.Conv2d(1, n_class, 1)
        self.final_4 = nn.Conv2d(1, n_class, 1)
        self.final_3 = nn.Conv2d(1, n_class, 1)
        self.final_5 = nn.Conv2d(1, n_class, 1)
    ...
    def forward(self, x):
        ...
        # print(final_5.shape)
        outputs = []
        outputs.append(final_5)
        outputs.append(final_4)
        outputs.append(final_3)
        outputs.append(final_2)
        outputs.append(final_1)

        # return outputs
        return (final_5 + final_4 + final_3 + final_2 + final_1) / 5


if __name__ == '__main__':
    ras = Inf_Net(n_class=2).cuda()
    input_tensor = torch.randn(1, 3, 224, 224).cuda()

    from torchsummary import summary

    print(summary(ras, (3, 224, 224)))
