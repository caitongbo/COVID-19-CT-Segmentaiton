...
from models.swin_resnet.backbone.resnet import resnet50
...
class SwinRes_UperNet(nn.Module):
    def __init__(self, num_classes=21, sync_bn=True, freeze_bn=False):
        ...
        self.backbone1 = SwinTransformer(
            ...
            drop_path_rate=0.3,
            patch_norm=True,
            pretrained='/root/workspace/data/ctb/COVID-19-CT/myct/MiniSeg/pretrained_weights/swin_base_patch4_window7_224_22k.pth'
        )
