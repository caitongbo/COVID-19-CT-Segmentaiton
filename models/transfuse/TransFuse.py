...
class TransFuse_S(nn.Module):
    def __init__(self, num_classes=1, drop_rate=0.2, normal_init=True, pretrained=False):
        ...
        self.resnet = resnet()
        if pretrained:
            self.resnet.load_state_dict(torch.load('/root/.cache/torch/hub/checkpoints/resnet34-b627a593.pth'))
        ...
        self.conv1x1 = nn.Conv2d(in_channels=3, out_channels=2, kernel_size=1)
    ...
    def forward(self, imgs, labels=None):
        ...
        out = torch.cat((map_x, map_1, map_2), 1)
