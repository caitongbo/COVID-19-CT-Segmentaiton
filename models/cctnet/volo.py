...
from models.cctnet.checkpoint import load_checkpoint
...
class VOLO(nn.Module):
    ...
    def __init__(self, nclass, img_size, embed_dim, layers, num_heads, mlp_ratios, downsamples, outlook_attention,
...
def volo_d1(nclass, img_size, pretrained=False, aux=False, head='uperhead', edge_aux=False):
    if pretrained:
        pretrained_root = './pretrained_weights/d1_384_85.2.pth.tar'
    else:
...
def volo_d2(nclass, img_size, pretrained=False, aux=False, head='uperhead', edge_aux=False):
    if pretrained:
        pretrained_root = './pretrained_weights/d2_384_86.0.pth.tar'
    else:
        pretrained_root = None
...
def volo_d3(nclass, img_size, pretrained=False, aux=False, head='uperhead', edge_aux=False):
    if pretrained:
        pretrained_root = './pretrained_weights/d3_448_86.3.pth.tar'
    else:
        pretrained_root = None
...
def volo_d4(nclass, img_size, pretrained=False, aux=False, head='uperhead', edge_aux=False):
    if pretrained:
        pretrained_root = './pretrained_weights/d4_448_86.79.pth.tar'
    else:
        pretrained_root = None
...
def volo_d5(nclass, img_size, pretrained=False, aux=False, head='uperhead', edge_aux=False):
    if pretrained:
...
if __name__ == '__main__':
    ...
    model_base = volo_d1(nclass=6, img_size=512, aux=True, edge_aux=False, head='mlphead', pretrained=True)
