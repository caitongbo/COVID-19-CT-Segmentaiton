...
def swin_tiny(nclass, img_size=None, pretrained=False, aux=False, head='uperhead', edge_aux=False):
    if pretrained:
        ...
        pretrained_root = '/workspace/ct/weights/swin_tiny_patch4_window7_224.pth'
    else:
...
def swin_small(nclass, img_size=None, pretrained=False, aux=False, head='uperhead', edge_aux=False):
    if pretrained:
        ...
        pretrained_root = '/workspace/ct/pretrained_weights/swin_small_patch4_window7_224_22k.pth'
    else:
        pretrained_root = None
...
def swin_base(nclass, img_size=None, pretrained=False, aux=False, head='uperhead', edge_aux=False):
    if pretrained:
        ...
        pretrained_root = '/workspace/ct/weights/swin_base_patch4_window7_224.pth'
