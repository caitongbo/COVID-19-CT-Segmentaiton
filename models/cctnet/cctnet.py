...
# from .resT import rest_tiny, rest_small, rest_base, rest_large
from .swinT import swin_tiny, swin_small, swin_base, swin_large
# from .volo import volo_d1, volo_d2, volo_d3, volo_d4, volo_d5
# from .cswin import cswin_tiny, cswin_base, cswin_small, cswin_large
# from .beit import beit_base, beit_large
