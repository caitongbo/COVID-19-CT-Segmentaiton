...
from models.Res2Net_PraNet import res2net50_v1b_26w_4s, res2net101_v1b_26w_4s
...
class PraNet(nn.Module):
    ...
    def forward(self, x):
        ...
        x = ra4_feat + crop_4
        lateral_map_4 = F.interpolate(x, scale_factor=16,
        ...
        # final layer
        final_1 = self.final_1(lateral_map_2)
        final_2 = self.final_2(lateral_map_3)
        final_3 = self.final_3(lateral_map_4)
        final_5 = self.final_5(lateral_map_5)
        return (final_5 + final_3 + final_2 + final_1) / 4


if __name__ == '__main__':
    # ras = PraNet(num_classes=20).cuda()
