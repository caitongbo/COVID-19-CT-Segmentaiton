...
class PoolFormer(nn.Module):
    ...
    def __init__(self, layers, embed_dims=None, 
        ...
        self.c2 = nn.Conv2d(768,2,kernel_size=1)
        self.decode_head = SegHead(in_channels=[96, 192, 384, 768], num_classes=2, in_index=[0, 1, 2, 3])
        ...
        self.auxiliary_head = FCNHead(num_convs=1, in_channels=384, num_classes=2, in_index=2, channels=256)

        self.edge_head = EdgeHead(in_channels=[96, 192, 384], in_index=[0, 1], channels=96)
