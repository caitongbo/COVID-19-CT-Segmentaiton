...
class PyramidFeatures(nn.Module):
    def __init__(self, config, img_size = 224, in_channels=3):
        ...
        # self.swin_transformer = SwinTransformer(img_size,in_chans = 3, embed_dim=128,depths=[2, 2, 18, 2], window_size=7, num_heads=[4, 8, 16, 32], head_dim=[128, 256, 512, 1024])
...
class All2Cross(nn.Module):
    def __init__(self, config, img_size = 224 , in_chans=3, embed_dim=(96, 192, 384, 768), norm_layer=nn.LayerNorm):
        super().__init__()
